...
BEGIN
    INSERT INTO tbl_material_edu (mat_titulo, mat_ano_publicacion, mat_url_descarga, mat_precio, mat_keywords, mat_formato, tbl_editorial_edi_id) 
    VALUES (titulo, ano_publicacion, url_descarga, precio, keywords, formato, editorial_id);
END //
DELIMITER ;
